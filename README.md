...
**手游 V1.0** ·《青崖山开门》第一卷 · 地图与 NPC 对话版。

版本标签：`v1.0.0-mobile`。包含当前已完成的双皮肤、横竖屏、剧情存档和营地对话玩法；版本记录见 [手游 V1.0](docs/mobile-v1.0.md)。

35 段图文剧情、五幕、3 个卷末发展方向、12 项生态观察和 6 个建设里程碑。玩家选择影响供水、后勤、安置、秩序、观察与合作，并记录在建设手记中。

新增第一阶段营地玩法：从首页「青崖山地图」进入，EP13 起开放 NPC 对话，选择影响营地指数并自动保存。见 [地图与事件说明](docs/town-events.md)。

新增剧情演出：11 段场景支持底部对话框、放大立绘、情绪姿态与氛围特效，逐句阅读位置自动保存。见 [演出说明](docs/story-performance.md)。
